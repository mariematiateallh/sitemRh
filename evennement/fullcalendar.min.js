...
Grid.mixin({
	...
	renderEvents: function(events) {
		var e, bgEvents = [],
		fgEvents = [];
		for (e = 0; e < events.length; e++)(isBgEvent(events[e]) ? bgEvents : fgEvents).push(events[e]);
	...
	renderFgSegEls: function(segs, disableResizing) {
		...
		if (segs.length) { // don't build an empty html string
			...
			$(html).each(function(i, node) {
				...
				el && (el.data("fc-seg", seg), seg.el = el, renderedSegs.push(seg))
...
function isBgEvent(t) { // returns true if background OR inverse-background
	var e = kt(t);
...
var YearView = FC.YearView = View.extend({
	...
	buildSkeleton: function(monthsPerRow, showNumbers) {
		...
		for (n=0; n<7; n++) {
			weekNames[n] = FC.moment([ 2012, 11, 1+n ]).format('ddd');
		}
