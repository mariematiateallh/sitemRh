...
--
-- Hôte : 127.0.0.1
-- Généré le : mer. 07 juin 2023 à 11:21
...
(1, 'Développement', '2023-06-01 10:16:33', '2023-06-01 10:16:33'),
(2, 'Digital marketing', '2023-06-01 10:17:13', '2023-06-01 10:17:13'),
(3, 'Design', '2023-06-01 10:17:50', '2023-06-01 10:17:50'),
...
CREATE TABLE `user` (
  ...
  `etat_user` enum('0','1') NOT NULL DEFAULT '1',
...
INSERT INTO `user` (`id_user`, `nom_user`, `prenom_user`, `cin_user`, `numTel_user`, `email_user`, `password_user`, `date_naissance_user`, `id_role`, `id_specialité`, `adresse_user`, `photo_user`, `etat_user`, `date-created_user`, `date-updated_user`) VALUES
...
(4, 'siwar kassas', 'siwar', 111, 27125578, 'ssss@gmail.com', '0000', '2023-06-02', 1, 2, 'ajim 4135 djerba mednine', 'ac5db9c956113c62526d8d832376a53412516cab6ff2dde17ab4e59b53549470_docphotoProfile.jpg', '0', '2023-06-06 16:51:22', '2023-06-06 16:51:22');
...
ALTER TABLE `user`
  ...
  ADD CONSTRAINT `user_ibfk_2` FOREIGN KEY (`id_specialité`) REFERENCES `specialite` (`id_specialite`);
COMMIT;
